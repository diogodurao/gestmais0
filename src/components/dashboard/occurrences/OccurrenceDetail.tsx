...
import { deleteOccurrence, updateOccurrenceStatus } from "@/lib/actions/occurrences"
...
export function OccurrenceDetail({
    ...
    const handleStatusChange = async (newStatus: string) => {
        ...
        if (result.success) {
            addToast({ title: "Sucesso", description: "Estado atualizado", variant: "success" })
        } else {
            addToast({ title: "Erro", description: result.error, variant: "error" })
        }
                            ...
                            <FormField>
                                ...
                                <FormControl>
                                    {(props) => (
                                        ...
                                        >
                                            {Object.entries(OCCURRENCE_STATUS_CONFIG).map(([value, { label }]) => (
