            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                ...
                <div className="p-8 bg-white border border-slate-300 shadow-[4px_4px_0px_#cbd5e1]">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <h3 className="font-bold text-slate-900 uppercase tracking-tighter text-sm">
                            {dict.features.cards.finance.title}
                        </h3>
                    </div>
                    <ul className="space-y-3 pl-2 border-l border-slate-200">
                        {dict.features.cards.finance.items.map((item: string, i: number) => (
                ...
                <div className="group">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="font-bold text-slate-900 uppercase tracking-tighter text-sm">
                            {dict.features.cards.occurrences.title}
                        </h3>
                    </div>
                    <ul className="space-y-3 pl-2 border-l border-slate-200">
                        {dict.features.cards.occurrences.items.map((item: string, i: number) => (
                            <li key={i} className="flex items-start gap-2 text-xs font-mono text-slate-600">
                                <span>- {item}</span>
                            </li>
                        ))}
                ...
                <div className="group">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="font-bold text-slate-900 uppercase tracking-tighter text-sm">
                            {dict.features.cards.documents.title}
                        </h3>
                    </div>
                    <ul className="space-y-3 pl-2 border-l border-slate-200">
                        {dict.features.cards.documents.items.map((item: string, i: number) => (
                            <li key={i} className="flex items-start gap-2 text-xs font-mono text-slate-600">
                                <span>- {item}</span>
                            </li>
                        ))}
